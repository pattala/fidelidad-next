...
function showGlobalAlert(fullData, adminUrl) {
    const birthdays = fullData.birthdays?.totalToday || 0;
    const expirations = fullData.expirations?.totalInWindow || fullData.expirations?.summary?.totalInWindow || 0;
    const petAlerts = fullData.petAlerts?.results?.notified || 0;
