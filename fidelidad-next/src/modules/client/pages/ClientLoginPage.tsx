...
export const ClientLoginPage = () => {
    ...
    return (
        <div className="min-h-[100dvh] bg-gray-50 flex-col items-center p-4 sm:p-6 pb-12 sm:pb-8 relative overflow-x-hidden w-full overflow-y-auto block sm:flex">
            ...
            <div className="relative z-10 w-full max-w-sm shrink-0 py-8 sm:py-0 mx-auto">
                ...
                {/* Login Card */}
                <div className="bg-white p-6 sm:p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 backdrop-blur-sm">
                    <h2 className="text-lg sm:text-xl font-bold text-gray-800 mb-4 sm:mb-6 text-center">Iniciar Sesión</h2>
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="absolute right-4 top-3 text-gray-400 hover:text-purple-600 transition"
                            >
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gray-900 text-white py-3 sm:py-4 rounded-2xl font-bold text-sm shadow-lg shadow-gray-900/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2 group disabled:opacity-70 disabled:scale-100 mt-2"
                        >
                            {loading ? (
                                'Ingresando...'
                            ) : (
