...
export const MysteryBoxPage = () => {
    ...
    if (status === 'loading') {
        return (
            <div className="fixed inset-0 z-[35] pt-[80px] pb-[90px] overflow-hidden bg-gray-900 flex flex-col items-center justify-center p-4">
    ...
    if (status === 'won') {
        return (
            <div className="fixed inset-0 z-[35] pt-[80px] pb-[90px] overflow-hidden bg-gradient-to-br from-green-900 via-emerald-900 to-black flex flex-col items-center justify-center p-4">
    ...
    return (
        <div className="fixed inset-0 z-[35] pt-[80px] pb-[90px] overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-black flex flex-col items-center justify-center p-4">
            {/* Background elements */}
