            ...
            <div className="min-h-[100dvh] pt-24 pb-28 bg-gradient-to-br from-green-900 via-emerald-900 to-black flex items-center justify-center p-4">
                <div className="bg-white/10 backdrop-blur-xl p-8 rounded-[30px] border border-white/20 text-center max-w-sm w-full animate-in zoom-in duration-500">
                    ...
                    {user ? (
                        ...
                        <>
                            <h2 className="text-2xl md:text-3xl font-black text-white mb-3 drop-shadow-md">¡Tus {pointsWon} puntos ya están guardados! 🎁</h2>
                            <p className="text-green-300 font-medium mb-6 md:mb-8 text-sm md:text-base leading-snug">Descubrí si este saldo ya te alcanza para llevarte tu primer premio gratis... Iniciá sesión para ver tu catálogo.</p>
