...
export const ClientActivityPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col pb-20">
            {/* Header */}
            <div className="bg-white px-4 pt-6 pb-4 sticky top-0 z-20 shadow-sm border-b border-gray-100 transition-all">
                <div className="flex flex-col">
                    <h1 className="text-2xl font-bold text-gray-800 leading-none">Tu Actividad</h1>
                    <p className="text-gray-400 text-[10px] font-medium mt-1.5 uppercase tracking-wider">Historial de puntos y canjes</p>
                </div>
